 ...
 *
 */
var my_dailog_open = 0;

(function($){
var upbodyheight = 300;
...
catch(ccceee)
{
	...
	if($(this)[0].className && $(this)[0].className.indexOf("easyui-dialog")==0)
	{
		if(my_dailog_open==1)
		{
			$("html").height(upbodyheight);
			$("html").css("overflow-y","scroll");
		}
		//debugger;
		//console.log(my_dailog_open);
		my_dailog_open --;
	}
}
},onOpen:function(){
...
catch(ccceee)
{
	if( $(this)[0].className && $(this)[0].className.indexOf("easyui-dialog")==0)
	{
		if(my_dailog_open ==0)
		{
			upbodyheight = $("html").height();
			document.body.scrollTop = 0;
			$("html").height(parent.$mainbodyheight);
...
_285.proxy._outerHeight(parent.$mainbodyheight||_285.window._outerHeight());
setTimeout(function(){
if(_285.proxy){
_285.proxy.show();
}
...
if(opts.maxlength)
{
	tb.find(".textbox-text").attr("maxlength",opts.maxlength);
}
...
_647(this,data);
_702(this);
var nd_id = $(this).datagrid("options").id;
if(nd_id=="dg")
{
	try
	{
		var bodylayout = $($("#dg").parents("div")[$("#dg").parents("div").length-1]);
		var northHeight = 80;
		if(bodylayout.find("div.panel.layout-panel.layout-panel-north"))
		{
			northHeight = 0;
			var lenbodypan = bodylayout.find("div.panel.layout-panel.layout-panel-north");
			$.each(lenbodypan,function(index,panlen){
				northHeight += $(panlen).height()+20;
			});
		}
		var  yqgd1 = $($("#dg").parents("div")[0]).find(".datagrid-btable")[1].clientHeight + northHeight + 80;
		var phz =  parent.$mainbodyheight;
		//console.log(yqgd1);
		$("html").css("overflow-y","scroll");
		if(yqgd1>phz)
		{
		...
		bodylayout.layout('resize', {width:'100%',height:'100%'});
	}
	catch(eeee)
	{
		//console.log(eeee);
...
(function($){
        var  callee=$.fn.form.methods.submit;
        $.extend($.fn.form.methods,{
            submit:function(){
                arguments[1].url=window.getUrlSuffixByUrlAjax(arguments[1].url);
                callee.apply(arguments[0],arguments)
            }
        })
    }
)(jQuery)
